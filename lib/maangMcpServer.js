...
import { z } from 'zod';
import { getMaangPrices, getMaangIndicators, getMaangBacktest } from './market.js';

export function createMaangServer() {
  ...
  server.registerTool(
    ...
    {
      description: 'Returns live and historical price data for a given MAANG stock (Meta, Apple, Amazon, Netflix, Google). The result comes from upstream market APIs (Yahoo Finance, Alpha Vantage, Polygon). Use this tool when an agent needs raw OHLC data or live prices for analysis. It does not cover non‑MAANG stocks or crypto.',
      inputSchema: {
